...
private:
	vector<std::string> m_currentStringVector; //Currently added strings
	vector<std::string> m_candidateStringVector; //Possible strings that could be palindromes.
	vector<vector<string>> m_validPalindromes; //Vectors of valid palindromes.
	int m_countPalindromeSentences; //Number of valid palindromes.
